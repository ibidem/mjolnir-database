 ...
 */
class Task_Db_Sphinx extends \app\Task
{
	/**
	 * Execute task.
	 */
	...
	function regenerate()
	{
		...
		$sph_conf = "#\n# The following is an auto-generated configuration file.\n"
		          . "# Please DO NOT edit this file; for updates use ./order sphinx -r\n#\n"
		          . "# @generator Mjolnir\n"
		...
		$sph_configuration_file = DOCROOT.'drafts/sphinx/sphinx.conf.mj';
